...
A curated list of awesome applications, software, tools, and resources for using *BSD as a daily driver. Inspired by the various Awesome lists that exist for a wide variety of tech ecosystems and the robust, secure, and quality codebase of *BSD.
...
- [Raffael Schneider - GitHub](https://github.com/raffaelschneider/awesome-openbsd-desktop) - Author of this Document